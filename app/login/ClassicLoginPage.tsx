...
export default function ClassicLoginPage() {
    ...
    // All original logic remains identical...
    useEffect(() => {
        ...
        try {
            ...
            if (response.ok) {
                if (data.emailVerified === false) {
                    ...
                    router.push(`/verify-otp?view=classic${callbackUrl ? `&callbackUrl=${encodeURIComponent(callbackUrl)}` : ''}`);
                    return;
                }
                ...
                if (data.twoFactorRequired) {
                    ...
                    router.push(`/login/2fa?view=classic&token=${data.preAuthToken}${callbackQuery}`);
                    return;
                } else {
            ...
            <div className="flex min-h-[calc(100vh-80px)] items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">Sign in to your What'sYour.Info account</p>
                    </div>
                    <Card className="border-gray-200 shadow-lg">
                        <CardHeader><CardTitle>Sign in to your account</CardTitle><CardDescription>Access your profile dashboard and settings</CardDescription></CardHeader>
                        <CardContent>
                            ...
                            <div className="mt-6">
                                <div className="relative"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-300" /></div><div className="relative flex justify-center text-sm"><span className="bg-white px-2 text-gray-500">Don't have an account?</span></div></div>
                    ...
                    {/* --- Link to switch to the new view --- */}
